<div>
    <ui-select ng-model="ctrl.formsLibrary.selected" theme="bootstrap">
        <ui-select-match placeholder="Select or search for a forms library...">
        ...
        <ui-select-choices repeat="item in ctrl.formsLibraries | filter: $select.search">
            <div>
