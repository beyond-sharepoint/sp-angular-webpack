...
try {
    var spoRemoteAuth = require("@beyond-sharepoint/spo-remote-auth");
}
catch (ex) {
    console.log("The deploy-proxy-spo and deploy-app-spo commands require @beyond-sharepoint/spo-remote-auth");
    console.log("Could not load @beyond-sharepoint/spo-remote-auth - this depencency requires node-gyp");
    console.log("Please follow installation directions at https://github.com/nodejs/node-gyp for installation");
    process.exit()
}
